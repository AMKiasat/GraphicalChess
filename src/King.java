...
public class King extends Man {
    ...
    public boolean movement(int x, int y, Ground ground) {
        if (x >= 0 && x < 8 && y >= 0 && y < 8 && !(this.x == x && this.y == y)) {
            if (((this.x + 1 == x && this.y + 1 == y) || (this.x + 1 == x && this.y == y) || (this.x + 1 == x && this.y - 1 == y) || (this.x == x && this.y + 1 == y) || (this.x == x && this.y - 1 == y) || (this.x - 1 == x && this.y + 1 == y) || (this.x - 1 == x && this.y == y) || (this.x - 1 == x && this.y - 1 == y)) && !((this.name.toCharArray()[0] == 'B' && ground.blackKingCheck(x, y)) || (this.name.toCharArray()[0] == 'W' && ground.whiteKingCheck(x, y)))) {
                for (int i = 0; i < 8; i++)
                    for (int j = 0; j < 8; j++) {
